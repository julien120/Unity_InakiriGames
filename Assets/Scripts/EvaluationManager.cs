...
public class EvaluationManager : MonoBehaviour
{
    ...
    private static readonly Dictionary<JudgementType, float> ScoreAddRates = new Dictionary<JudgementType, float>()
        {
    ...
    void Start()
    {
        ...
        //理論コンボ数は(シングルノーツの個数)+(ロングノーツの個数)*2
        TheoreticalCombo =
            PlayerControllers.beatmap.noteProperties
