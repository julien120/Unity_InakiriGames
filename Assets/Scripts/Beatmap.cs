...
public class Beatmap
{
    ...
    //sec =beat/(BPM/60) BPMとはbeat per minute =1分あたりの脈数
    ...
    public static float ToBeat(float sec, List<TempoChange> tempoChanges)
    {
        ...
        //変換するsecが最後のテンポ変化よりも後にあるとき、
        //最後のテンポ変化があるbeat*残りのbeatを返す
